...
describe('exists', async () => {
  ...
  //
  // CustomerioPipelinesSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof CustomerioPipelinesSDK, true,
      'CustomerioPipelinesSDK.test() must return a client synchronously')
  })
