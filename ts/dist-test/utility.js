...
function envOverride(m) {
    if ('TRUE' === process.env.CUSTOMERIO_PIPELINES_TEST_LIVE ||
        'TRUE' === process.env.CUSTOMERIO_PIPELINES_TEST_OVERRIDE) {
    ...
    m.CUSTOMERIO_PIPELINES_TEST_EXPLAIN = process.env.CUSTOMERIO_PIPELINES_TEST_EXPLAIN || m.CUSTOMERIO_PIPELINES_TEST_EXPLAIN;
    return m;
}
