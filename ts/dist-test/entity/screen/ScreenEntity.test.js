...
(0, node_test_1.describe)('ScreenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'screen.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != screen_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/screen/ScreenTestData.json');
    ...
    let idmap = transform(['screen01', 'screen02', 'screen03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ScreenEntity.test.js.map