...
describe("BatchEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CUSTOMERIO_PIPELINES_TEST_BATCH_ENTID JSON to run live")
      return
    end
    ...
    local batch_ref01_data = helpers.to_map(vs.getprop(
...
function batch_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CUSTOMERIO_PIPELINES_TEST_BATCH_ENTID")
