...
local SDK_MODULE = "customerio-pipelines_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["alia"] = { ["test01"] = { id = "test01" } }, ["batch"] = { ["test01"] = { id = "test01" } }, ["group"] = { ["test01"] = { id = "test01" } }, ["identify"] = { ["test01"] = { id = "test01" } }, ["page"] = { ["test01"] = { id = "test01" } }, ["screen"] = { ["test01"] = { id = "test01" } }, ["track"] = { ["test01"] = { id = "test01" } } } }'
