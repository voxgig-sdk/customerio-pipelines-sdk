...
function runner.env_override(m)
  local live = runner.getenv("CUSTOMERIO_PIPELINES_TEST_LIVE")
  local override = runner.getenv("CUSTOMERIO_PIPELINES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOMERIO_PIPELINES_TEST_EXPLAIN")
