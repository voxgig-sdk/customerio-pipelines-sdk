...
local IdentifyEntity = {}
IdentifyEntity.__index = IdentifyEntity


function IdentifyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IdentifyEntity)
  self._name = "identify"
  self._client = client
...
function IdentifyEntity:get_name()
  return self._name
end


function IdentifyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IdentifyEntity.new(self._client, opts)
end
...
function IdentifyEntity:mark_deleted()
  self._deleted = true
end


function IdentifyEntity:deleted()
  return true == self._deleted
end


function IdentifyEntity:data_set(args)
  if args ~= nil then
...
function IdentifyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IdentifyEntity:match_set(args)
  if args ~= nil then
...
function IdentifyEntity:match_get()
...
function IdentifyEntity:stream(action, args, callopts)
...
---@param reqdata IdentifyCreateData
---@param ctrl? table
---@return Identify
---@return string? err
function IdentifyEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function IdentifyEntity:_run_op(ctx, post_done)
  local utility = self._utility
