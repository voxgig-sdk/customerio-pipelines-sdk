// Command CustomerioPipelines-mcp is an MCP server exposing the CustomerioPipelines
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CustomerioPipelines_list  — list records of an entity
//	CustomerioPipelines_load  — load a single record of an entity
//
