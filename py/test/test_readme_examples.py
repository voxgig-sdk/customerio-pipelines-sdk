# CustomerioPipelines SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CustomerioPipelinesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CustomerioPipelinesSDK(...) and CustomerioPipelinesSDK.test(...) become
#      CustomerioPipelinesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "customeriopipelines_sdk"
_SDK_CLASS = "CustomerioPipelinesSDK"
