...
from customeriopipelines_sdk.core.control import CustomerioPipelinesControl
...
from customeriopipelines_sdk.core.helpers import get_ctx_prop, to_map
...
class CustomerioPipelinesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CustomerioPipelinesControl()
        ...
        if isinstance(sp, CustomerioPipelinesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CustomerioPipelinesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CustomerioPipelinesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CustomerioPipelinesOperation({})
        ...
        op = CustomerioPipelinesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return CustomerioPipelinesError(code, msg, self)
