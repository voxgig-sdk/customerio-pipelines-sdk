...
from customeriopipelines_sdk.customeriopipelines_types import (
    Identify,
    IdentifyCreateData,
)
...
class IdentifyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IdentifyEntity(self._client, opts)
    ...
    def create(self, reqdata: IdentifyCreateData, ctrl=None) -> Identify:
        utility = self._utility
