...
const testSeed = `map[string]any{"entity": map[string]any{"alia": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "identify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "screen": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "track": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
