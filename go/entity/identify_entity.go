...
type IdentifyEntity struct {
	name    string
	client  *core.CustomerioPipelinesSDK
...
func NewIdentifyEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *IdentifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdentifyEntity) GetName() string { return e.name }
...
func (e *IdentifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdentifyEntity) Deleted() bool {
	return e.deleted
}


func (e *IdentifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdentifyEntity(e.client, opts)
}

func (e *IdentifyEntity) Data(args ...any) any {
...
func (e *IdentifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Identify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdentifyEntity) DataTyped(data ...Identify) Identify {
	if len(data) > 0 {
		return typedFrom[Identify](e.Data(asMap(data[0])))
	}
	return typedFrom[Identify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Identify (all fields
// optional at the wire level).
func (e *IdentifyEntity) MatchTyped(match ...Identify) Identify {
	if len(match) > 0 {
		return typedFrom[Identify](e.Match(asMap(match[0])))
	}
	return typedFrom[Identify](e.Match())
}
...
func (e *IdentifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdentifyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IdentifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IdentifyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdentifyCreateData and returns an Identify. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IdentifyEntity) CreateTyped(reqdata IdentifyCreateData, ctrl map[string]any) (Identify, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Identify{}, err
	}
	return typedFrom[Identify](res), nil
}



func (e *IdentifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IdentifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IdentifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
