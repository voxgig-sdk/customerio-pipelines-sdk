...
func NewTrackEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *TrackEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrackEntity) GetName() string { return e.name }
...
func (e *TrackEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrackEntity) Deleted() bool {
	return e.deleted
}


func (e *TrackEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrackEntity(e.client, opts)
}

func (e *TrackEntity) Data(args ...any) any {
...
func (e *TrackEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Track; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrackEntity) DataTyped(data ...Track) Track {
	if len(data) > 0 {
		return typedFrom[Track](e.Data(asMap(data[0])))
	}
	return typedFrom[Track](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Track (all fields
// optional at the wire level).
func (e *TrackEntity) MatchTyped(match ...Track) Track {
	if len(match) > 0 {
		return typedFrom[Track](e.Match(asMap(match[0])))
	}
	return typedFrom[Track](e.Match())
}
...
func (e *TrackEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrackEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TrackEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TrackEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrackCreateData and returns an Track. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TrackEntity) CreateTyped(reqdata TrackCreateData, ctrl map[string]any) (Track, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Track{}, err
	}
	return typedFrom[Track](res), nil
}



func (e *TrackEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrackEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrackEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
