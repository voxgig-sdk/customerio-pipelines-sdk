...
func NewGroupEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *GroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GroupEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *GroupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
