...
func NewPageEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *PageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PageEntity) GetName() string { return e.name }
...
func (e *PageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PageEntity) Deleted() bool {
	return e.deleted
}


func (e *PageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPageEntity(e.client, opts)
}

func (e *PageEntity) Data(args ...any) any {
...
func (e *PageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Page; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PageEntity) DataTyped(data ...Page) Page {
	if len(data) > 0 {
		return typedFrom[Page](e.Data(asMap(data[0])))
	}
	return typedFrom[Page](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Page (all fields
// optional at the wire level).
func (e *PageEntity) MatchTyped(match ...Page) Page {
	if len(match) > 0 {
		return typedFrom[Page](e.Match(asMap(match[0])))
	}
	return typedFrom[Page](e.Match())
}
...
func (e *PageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PageCreateData and returns an Page. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PageEntity) CreateTyped(reqdata PageCreateData, ctrl map[string]any) (Page, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Page{}, err
	}
	return typedFrom[Page](res), nil
}



func (e *PageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
