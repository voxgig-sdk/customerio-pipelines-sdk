...
func NewAliaEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *AliaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AliaEntity) GetName() string { return e.name }
...
func (e *AliaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AliaEntity) Deleted() bool {
	return e.deleted
}


func (e *AliaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAliaEntity(e.client, opts)
}

func (e *AliaEntity) Data(args ...any) any {
...
func (e *AliaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Alia; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AliaEntity) DataTyped(data ...Alia) Alia {
	if len(data) > 0 {
		return typedFrom[Alia](e.Data(asMap(data[0])))
	}
	return typedFrom[Alia](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Alia (all fields
// optional at the wire level).
func (e *AliaEntity) MatchTyped(match ...Alia) Alia {
	if len(match) > 0 {
		return typedFrom[Alia](e.Match(asMap(match[0])))
	}
	return typedFrom[Alia](e.Match())
}
...
func (e *AliaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AliaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AliaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AliaEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AliaCreateData and returns an Alia. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AliaEntity) CreateTyped(reqdata AliaCreateData, ctrl map[string]any) (Alia, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Alia{}, err
	}
	return typedFrom[Alia](res), nil
}



func (e *AliaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AliaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AliaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
