...
func NewScreenEntity(client *core.CustomerioPipelinesSDK, entopts map[string]any) *ScreenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScreenEntity) GetName() string { return e.name }
...
func (e *ScreenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScreenEntity) Deleted() bool {
	return e.deleted
}


func (e *ScreenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScreenEntity(e.client, opts)
}

func (e *ScreenEntity) Data(args ...any) any {
...
func (e *ScreenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Screen; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScreenEntity) DataTyped(data ...Screen) Screen {
	if len(data) > 0 {
		return typedFrom[Screen](e.Data(asMap(data[0])))
	}
	return typedFrom[Screen](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Screen (all fields
// optional at the wire level).
func (e *ScreenEntity) MatchTyped(match ...Screen) Screen {
	if len(match) > 0 {
		return typedFrom[Screen](e.Match(asMap(match[0])))
	}
	return typedFrom[Screen](e.Match())
}
...
func (e *ScreenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScreenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ScreenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ScreenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScreenCreateData and returns an Screen. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ScreenEntity) CreateTyped(reqdata ScreenCreateData, ctrl map[string]any) (Screen, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Screen{}, err
	}
	return typedFrom[Screen](res), nil
}



func (e *ScreenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScreenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScreenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
