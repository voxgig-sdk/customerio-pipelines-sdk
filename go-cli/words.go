...
func registerSDKWords(r *eng.Registry, client *sdk.CustomerioPipelinesSDK) {
...
func runOp(client *sdk.CustomerioPipelinesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
