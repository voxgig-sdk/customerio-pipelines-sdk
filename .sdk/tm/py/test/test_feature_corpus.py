# CustomerioPipelines SDK feature corpus test
#
...
def _client(kase):
    ...
    CustomerioPipelinesSDK(...), not CustomerioPipelinesSDK.test(...): the `test` feature is
    ...
    return CustomerioPipelinesSDK(opts)
