...
local function make_error_util(ctx, err)
  ...
  local msg = "CustomerioPipelinesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CustomerioPipelinesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CustomerioPipelinesError then
