...
// CustomerioPipelines SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CustomerioPipelinesTestFeature extends CustomerioPipelinesBaseFeature
{
    ...
    public function init(CustomerioPipelinesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CustomerioPipelinesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CustomerioPipelinesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CustomerioPipelinesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CustomerioPipelinesContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CustomerioPipelinesParam::call($ctx, $k);
