...
// CustomerioPipelines SDK utility: fetcher

class CustomerioPipelinesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CustomerioPipelinesSDK/1.0)';
    ...
    public static function call(CustomerioPipelinesContext $ctx, string $fullurl, array $fetchdef): array
    {
