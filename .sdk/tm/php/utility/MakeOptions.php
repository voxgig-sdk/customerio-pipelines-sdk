...
// CustomerioPipelines SDK utility: make_options

class CustomerioPipelinesMakeOptions
{
    ...
    public static function call(CustomerioPipelinesContext $ctx): array
    {
        ...
        //
        // `CustomerioPipelinesSchema::optspec()` is built from the model:
        ...
        $optspec = CustomerioPipelinesSchema::optspec();
