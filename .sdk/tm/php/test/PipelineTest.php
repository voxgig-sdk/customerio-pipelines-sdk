...
// CustomerioPipelines SDK pipeline test
//
...
{
    private static function utility(): CustomerioPipelinesUtility
    {
        return new CustomerioPipelinesUtility();
    }
    ...
    private static function ctx(array $over = []): CustomerioPipelinesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CustomerioPipelinesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CustomerioPipelinesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CustomerioPipelinesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CustomerioPipelinesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CustomerioPipelinesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomerioPipelinesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CustomerioPipelinesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CustomerioPipelinesResponse([]),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        [, $err] = CustomerioPipelinesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec([]),
            'response' => null,
            'result' => new CustomerioPipelinesResult([]),
        ]);
        [, $err] = CustomerioPipelinesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec(['step' => 's']),
            'response' => new CustomerioPipelinesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        [, $err] = CustomerioPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec(['step' => 's']),
            'response' => new CustomerioPipelinesResponse(self::resp(200, ['v' => 1])),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        [, $err] = CustomerioPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec(['step' => 's']),
            'response' => new CustomerioPipelinesResponse(self::resp(200, ['v' => 2])),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CustomerioPipelinesMakeResponse::call($ctx);
    ...
    {
        $preset = new CustomerioPipelinesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec([]),
            'response' => new CustomerioPipelinesResponse([]),
            'result' => new CustomerioPipelinesResult([]),
        ...
        [$got, $err] = CustomerioPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CustomerioPipelinesResult([])]);
        [, $err] = CustomerioPipelinesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CustomerioPipelinesSpec([]), 'result' => null]);
        [, $err] = CustomerioPipelinesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomerioPipelinesSpec(['step' => 's']),
            'result' => new CustomerioPipelinesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomerioPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomerioPipelinesSpec(['step' => 's']),
            'result' => new CustomerioPipelinesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CustomerioPipelinesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomerioPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomerioPipelinesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CustomerioPipelinesSpec([]),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CustomerioPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomerioPipelinesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CustomerioPipelinesError('boom', 'boom');
        $utility->fetcher = function (CustomerioPipelinesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomerioPipelinesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CustomerioPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CustomerioPipelinesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CustomerioPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CustomerioPipelinesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CustomerioPipelinesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CustomerioPipelinesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomerioPipelinesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CustomerioPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CustomerioPipelinesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CustomerioPipelinesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CustomerioPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CustomerioPipelinesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CustomerioPipelinesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CustomerioPipelinesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CustomerioPipelinesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CustomerioPipelinesResult(['ok' => false])]);
        $this->expectException(CustomerioPipelinesError::class);
        CustomerioPipelinesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CustomerioPipelinesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CustomerioPipelinesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CustomerioPipelinesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CustomerioPipelinesBaseFeature();
        $b = new CustomerioPipelinesBaseFeature();
        CustomerioPipelinesFeatureAdd::call($ctx, $a);
        CustomerioPipelinesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CustomerioPipelinesBaseFeature
    {
        $f = new CustomerioPipelinesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CustomerioPipelinesFeatureAdd::call($ctx, self::named_feature('a'));
        CustomerioPipelinesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CustomerioPipelinesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CustomerioPipelinesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CustomerioPipelinesFeatureAdd::call($ctx, $replace);
        ...
        CustomerioPipelinesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CustomerioPipelinesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CustomerioPipelinesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomerioPipelinesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CustomerioPipelinesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CustomerioPipelinesResponse(['headers' => null]),
            'result' => new CustomerioPipelinesResult([]),
        ]);
        CustomerioPipelinesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CustomerioPipelinesResultBody::call($ctx);
