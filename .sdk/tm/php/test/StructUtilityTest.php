...
// CustomerioPipelines SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CustomerioPipelinesOmni::makeStructRunner(
    ...
    {
        return CustomerioPipelinesOmni::objmodel(CustomerioPipelinesOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return CustomerioPipelinesOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return CustomerioPipelinesOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CustomerioPipelinesOmni::structfix($now, Struct::undef()))
                        !== json_encode(CustomerioPipelinesOmni::structfix($val, Struct::undef()))) {
