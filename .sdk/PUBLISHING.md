...
|---|---|---|
| `js/` | @voxgig-sdk/customerio-pipelines-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/customerio-pipelines | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/customerio-pipelines-js \
      --repository voxgig-sdk/customerio-pipelines-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/customerio-pipelines-js` shows it, and
`npm trust revoke @voxgig-sdk/customerio-pipelines-js --id=<id>` removes it.
