...
// CustomerioPipelines SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CustomerioPipelinesSDK::test)
...
{
    private const SDK_CLASS = 'CustomerioPipelinesSDK';
    ...
    private const SDK_BASE = 'customeriopipelines_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../customeriopipelines_sdk.php';
