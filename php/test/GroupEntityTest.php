...
class GroupEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMERIO_PIPELINES_TEST_GROUP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function group_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMERIO_PIPELINES_TEST_GROUP_ENTID");
