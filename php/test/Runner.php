...
class CustomerioPipelinesTestRunner
{
    ...
    {
        $live = self::getenv('CUSTOMERIO_PIPELINES_TEST_LIVE');
        $override = self::getenv('CUSTOMERIO_PIPELINES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CUSTOMERIO_PIPELINES_TEST_EXPLAIN');
...
class_alias('CustomerioPipelinesTestRunner', 'Runner');
class_alias('CustomerioPipelinesHelpers', 'Helpers');
