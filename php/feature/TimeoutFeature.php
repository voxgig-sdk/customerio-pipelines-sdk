...
// CustomerioPipelines SDK timeout feature
...
class CustomerioPipelinesTimeoutFeature extends CustomerioPipelinesBaseFeature
{
    ...
    private function _with_timeout(CustomerioPipelinesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CustomerioPipelinesContext $_ctx, float $ms): void
    {
        $client = $this->client;
