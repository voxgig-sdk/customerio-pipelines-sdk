...
// CustomerioPipelines SDK ratelimit feature
...
class CustomerioPipelinesRatelimitFeature extends CustomerioPipelinesBaseFeature
{
    ...
    private function _acquire(CustomerioPipelinesContext $ctx): void
    {
    ...
    private function _track(CustomerioPipelinesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
