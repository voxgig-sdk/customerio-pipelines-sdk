...
// CustomerioPipelines SDK paging feature
...
class CustomerioPipelinesPagingFeature extends CustomerioPipelinesBaseFeature
{
    ...
    private function _graphql_pre_request(CustomerioPipelinesContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CustomerioPipelinesContext $ctx): bool
    {
