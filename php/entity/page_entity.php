...
// CustomerioPipelines SDK Page entity
...
class PageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PageEntity($this->_client, $opts);
    }

    /**
     * @param Page|array $args Page data (assoc-array) to store.
     */
    ...
    /**
     * @return Page|array The current Page data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Page fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Page fields).
     */
     ...
     * Create a new Page.
     *
     * @param PageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Page|array The created Page as an assoc-array at the
