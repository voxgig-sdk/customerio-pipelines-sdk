...
// CustomerioPipelines SDK Batch entity
...
class BatchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BatchEntity($this->_client, $opts);
    }

    /**
     * @param Batch|array $args Batch data (assoc-array) to store.
     */
    ...
    /**
     * @return Batch|array The current Batch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Batch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Batch fields).
     */
     ...
     * Create a new Batch.
     *
     * @param BatchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BatchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Batch|array The created Batch as an assoc-array at the
