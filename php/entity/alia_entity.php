...
// CustomerioPipelines SDK Alia entity
...
class AliaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AliaEntity($this->_client, $opts);
    }

    /**
     * @param Alia|array $args Alia data (assoc-array) to store.
     */
    ...
    /**
     * @return Alia|array The current Alia data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Alia fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Alia fields).
     */
     ...
     * Create a new Alia.
     *
     * @param AliaCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AliaCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alia|array The created Alia as an assoc-array at the
