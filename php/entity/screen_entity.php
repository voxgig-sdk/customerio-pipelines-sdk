...
// CustomerioPipelines SDK Screen entity
...
class ScreenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ScreenEntity($this->_client, $opts);
    }

    /**
     * @param Screen|array $args Screen data (assoc-array) to store.
     */
    ...
    /**
     * @return Screen|array The current Screen data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Screen fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Screen fields).
     */
     ...
     * Create a new Screen.
     *
     * @param ScreenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ScreenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Screen|array The created Screen as an assoc-array at the
