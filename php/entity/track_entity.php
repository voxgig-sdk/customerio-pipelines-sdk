...
// CustomerioPipelines SDK Track entity
...
class TrackEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrackEntity($this->_client, $opts);
    }

    /**
     * @param Track|array $args Track data (assoc-array) to store.
     */
    ...
    /**
     * @return Track|array The current Track data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Track fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Track fields).
     */
     ...
     * Create a new Track.
     *
     * @param TrackCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TrackCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Track|array The created Track as an assoc-array at the
