...
// CustomerioPipelines SDK utility: feature_init

class CustomerioPipelinesFeatureInit
{
    public static function call(CustomerioPipelinesContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
