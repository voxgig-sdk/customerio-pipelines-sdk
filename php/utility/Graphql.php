...
// CustomerioPipelines SDK utility: graphql
//
...
class CustomerioPipelinesGraphql
{
    ...
    // equivalent.
    public static function body(CustomerioPipelinesContext $ctx): mixed
    {
    ...
    public static function errors(CustomerioPipelinesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
