...
// CustomerioPipelines SDK utility: result_basic

class CustomerioPipelinesResultBasic
{
    public static function call(CustomerioPipelinesContext $ctx): ?CustomerioPipelinesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CustomerioPipelinesError) ? $result->err->msg : (string)$result->err;
