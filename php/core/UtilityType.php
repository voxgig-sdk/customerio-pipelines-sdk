...
// CustomerioPipelines SDK utility type

class CustomerioPipelinesUtility
{
    ...
    public static function copy(CustomerioPipelinesUtility $src): CustomerioPipelinesUtility
    {
        $u = new CustomerioPipelinesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
